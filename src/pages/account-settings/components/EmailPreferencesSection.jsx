...
const EmailPreferencesSection = ({ isOpen, onToggle }) => {
    ...
    <div className="bg-surface rounded-lg border border-border shadow-elevation-1">
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-text-primary">Email Preferences</h3>
            <p className="text-sm text-text-secondary">Configure default email settings and notifications</p>
          </div>
        </div>
        <Icon 
          name="ChevronDown" 
